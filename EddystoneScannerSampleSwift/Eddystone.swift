...
class BeaconInfo : NSObject {
  ...
  class func frameTypeForFrame(_ advertisementFrameList: [NSObject : AnyObject])
    -> EddystoneFrameType {
  ...
  class func telemetryDataForFrame(_ advertisementFrameList: [NSObject : AnyObject]!) -> Data? {
